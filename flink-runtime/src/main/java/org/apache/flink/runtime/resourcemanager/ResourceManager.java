 ...
 * and bookkeeping.资源管理器主要负责Flink中的资源管理。它既与JobManager交互，又与TaskManager交互
 *
...
public abstract class ResourceManager<WorkerType extends ResourceIDRetrievable>
    ...
    /** All currently registered JobMasterGateways scoped by JobID. 以ResourceID为键，维护当前所有注册的JobManagerGateways */
    ...
    /** All currently registered TaskExecutors with there framework specific worker information. 以ResourceID为键，
     * 维护当前所有注册的TaskExecutor对应的worker对象。这个worker对象在不同模式下有不同的含义，如在YARN模式下，这个worker表示一个Container的封装 */
     ...
     * 以ResourceID为键，维护当前所有TaskExecutorGateway的CompletableFuture对象 */
    ...
    /** The slot manager maintains the available slots. 负责槽的管理 */
    ...
    /** The heartbeat manager with task managers. 表示TaskManager的心跳管理器 */
    private HeartbeatManager<TaskExecutorHeartbeatPayload, Void> taskManagerHeartbeatManager;

    /** The heartbeat manager with job managers. 表示JobManager的心跳管理器 */
