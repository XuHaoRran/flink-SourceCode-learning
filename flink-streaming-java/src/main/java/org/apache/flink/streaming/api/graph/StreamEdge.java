 ...
 *
 * <p>StreamEdge是StreamGraph中的边，用来连接两个StreamNode，一
...
public class StreamEdge implements Serializable {
    ...
    private StreamPartitioner<?> outputPartitioner; // 表示分区器

    /** The name of the operator in the source vertex. */
    private final String sourceOperatorName; // 表示输入的算子名称

    /** The name of the operator in the target vertex. */
    private final String targetOperatorName; // 表示输出的算子名称
