...
public class StreamNode {
    ...
    private @Nullable String slotSharingGroup; // 表示共享槽组
    private @Nullable String coLocationGroup;
    private KeySelector<?, ?>[] statePartitioners = new KeySelector[0];  //表示键的提取器
    ...
    private final Class<? extends TaskInvokable> jobVertexClass; // 该任务的执行类

    private InputFormat<?, ?> inputFormat;
    private OutputFormat<?> outputFormat;

    private String transformationUID; // 转换操作的uid
