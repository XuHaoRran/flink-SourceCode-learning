 ...
 * {@link OutputTag}.
 * <p>SideOutputTransformation在旁路输出中转换而来，表示上游Transformation的一个分流，
 * 上游Transformation可以有多个下游SideOutputTransformation。</>
 *
 *
 * <p>上游的OneInputTransformation分流给下游的多个
 * SideOutputTransformation，每一个SideOutput通过OutputTag进行标识。</>
